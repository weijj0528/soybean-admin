const local: App.I18n.Schema = {
  ...
  route: {
    ...
    demo: 'Function Demo',
    demo_function: 'System Function',
    demo_function_tab: 'Tab',
    'demo_function_multi-tab': 'Multi Tab',
    'demo_function_hide-child': 'Hide Child',
    'demo_function_hide-child_one': 'Hide Child',
    'demo_function_hide-child_two': 'Two',
    'demo_function_hide-child_three': 'Three',
    demo_function_request: 'Request',
    'demo_function_toggle-auth': 'Toggle Auth',
    'demo_function_super-page': 'Super Admin Visible',
    'demo_multi-menu': 'Multi Menu',
    'demo_multi-menu_first': 'Menu One',
    'demo_multi-menu_first_child': 'Menu One Child',
    'demo_multi-menu_second': 'Menu Two',
    'demo_multi-menu_second_child': 'Menu Two Child',
    'demo_multi-menu_second_child_home': 'Menu Two Child Home',
    exception: 'Exception',
    exception_403: '403',
    exception_404: '404',
    exception_500: '500',
    demo_plugin: 'Plugin',
    demo_plugin_copy: 'Copy',
    demo_plugin_charts: 'Charts',
    demo_plugin_charts_echarts: 'ECharts',
    demo_plugin_editor: 'Editor',
    demo_plugin_editor_quill: 'Quill',
    demo_plugin_editor_markdown: 'Markdown',
    demo_plugin_icon: 'Icon',
    demo_plugin_map: 'Map',
    demo_plugin_print: 'Print',
    demo_plugin_swiper: 'Swiper',
    demo_plugin_video: 'Video',
    demo_plugin_barcode: 'Barcode',
    demo_plugin_pinyin: 'pinyin',
    demo_plugin_excel: 'Excel',
    demo_plugin_pdf: 'PDF preview',
    demo_plugin_gantt: 'Gantt Chart',
    demo_plugin_typeit: 'Typeit',
